...
# ... and used pybind11 to generate python bindings for the fast_tt script \\
# ... (modified to use .dat file input/output to circumvent boost/pybind11 wrapper mismatch)
import xerus
import fast_tt
